...
public class BootcampJava {
	...
	private Set<DevJava> devInscritos = new HashSet<>();
	...
	public Set<DevJava> getDevInscritos() {
		return devInscritos;
	}

	public void setDevInscritos(Set<DevJava> devInscritos) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		BootcampJava other = (BootcampJava) obj;
